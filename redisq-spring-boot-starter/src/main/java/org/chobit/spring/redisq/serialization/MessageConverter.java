package org.chobit.spring.redisq.serialization;
...
public class MessageConverter {
	...
	public <T> Map<String, String> toMap(Message<T> message, PayloadSerializer payloadSerializer) {
	...
	public <T> Message<T> toMessage(Map<String, String> data, PayloadSerializer payloadSerializer, Class<T> payloadType) {
